...
export const team: TeamMemberData[] = [
  ...
  },
  {
    ...
    initials: 'LV',
    credentials:
      'Formado en Ingeniería Civil. Especializaciones en Gestión Inmobiliaria.',
    education:
      'Universidad Gabriela Mistral, Santiago, Chile. Pontificia Universidad Católica de Chile (PUC) y Universidad de Chile (UC).',
